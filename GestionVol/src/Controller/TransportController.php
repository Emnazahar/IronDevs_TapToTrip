...
class TransportController extends AbstractController
{
    ...
    {
        $message = new Swift_Message('Tap To Trip');
        $message->setFrom('svnoclip11@gmail.com');
        $message->setTo('yosrdahmeni6@gmail.com');
        $message->setBody('TapToTrip vous informe que votre transport a été réservé avec succés');
    ...
    public function Pay($idTransport,Request $request)
    {
        ...
        if ($request->isMethod('POST')) {
            ...
            if ($form->isValid()) {
                ...
                if ($user->getEmail() != $form['login']->getData()){
